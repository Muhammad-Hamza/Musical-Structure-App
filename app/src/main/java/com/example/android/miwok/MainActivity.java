    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coloursText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent colors = new Intent(MainActivity.this,coloursActivity.class);
        ...
        numbersText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent numbers = new Intent(MainActivity.this,numberActiviy.class);
                startActivity(numbers);
            }
        });


        TextView familyMemberText = (TextView) findViewById(R.id.family);
